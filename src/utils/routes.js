  ...
  // ── PLACE ───────────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        bearing: 265,
        distance: 120,
        label: "Baker Hall → College Chapel",
        duration: 5,
      },
      {
        bearing: 230,
      ...
      { bearing: 275, distance: 100, label: "Umali → Library", duration: 5 },
      { bearing: 185, distance: 160, label: "Library → CAS", duration: 5 },
      { bearing: 95, distance: 140, label: "CAS → Copeland Gym", duration: 5 },
      { bearing: 135, distance: 170, label: "Gym → Main Gate", duration: 5 },
    ],
  },
    ...
    steps: [
      {
        bearing: 225,
        distance: 280,
        label: "Rizal Monument → Grandstand",
        duration: 5,
      },
      {
        bearing: 90,
        distance: 320,
        label: "Grandstand → Agrifina Circle",
        duration: 5,
      },
      {
        bearing: 350,
        distance: 200,
        label: "Agrifina → National Museum",
        duration: 5,
      },
      {
        bearing: 45,
        distance: 250,
        label: "Nat. Museum → Liwasang",
        duration: 5,
      },
      {
        bearing: 195,
        distance: 310,
        label: "Liwasang → Rizal Monument",
        duration: 5,
      },
    ],
  },
